<div class="bg-white w-full grid place-items-center">
    <section class="px-6 md:px-[100px] pt-[50px] md:pt-[100px] pb-[78px] md:pb-[180px] max-w-[1440px]">
        <!-- Header -->
        ...
        <!-- Image -->
        <img class="mt-[50px] md:mt-[50px] w-full" src="{{ asset('images/services/1.png') }}" alt="img">
        <!-- Grid of Numbers | 3 Cols -->
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-[20px] mt-[100px] md:gap-[29px]">
            <!-- Item 1 -->
            ...
            <div class="bg-white flex flex-col ">
                ...
                <span class="font-black text-[0.75rem] md:text-[1.15rem] text-[#AFADB5] mt-[6px] leading-[1.8]">
                    ...
                    siding, decking, and outdoor spaces.
                </span>
            </div>
            <!-- Item 1 -->
            <div class="bg-white flex flex-col ">
